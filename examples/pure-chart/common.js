...
import { widthPercentageToDP } from "../../../../src/utils/util";
...
export const drawYAxis = (color = "#d9d9d9") => {
  return (
    <View
      style={{
        paddingLeft: 15,
...
export const drawYAxisLabels = (arr, height, minValue, color = "#2e2e2e") => {
  return (
    <View
      style={{
        width: 33,
    ...
    >
      {arr.length === 0 ? (
        ...
        >
          <Text style={{ fontSize: widthPercentageToDP(12) }}>0</Text>
        </View>
      ) : (
        arr.map((v, i) => {
...
export const drawXAxis = (color = "#d9d9d9") => {
  return (
    <View
      style={{
        width: "100%",
